...
IMAGENET = os.path.join(BASE_DIR, 'bowtie_tensorflow/tmp/imagenet')
NUM_TOP_PRPEDICTIONS = 1
...
class Processor(object):
	...
	def run_inference_on_image(self, image):
		...
		with tf.Session() as sess:
		    ...
		    top_k = predictions.argsort()[-NUM_TOP_PRPEDICTIONS:][::-1]
		    counter = 0
